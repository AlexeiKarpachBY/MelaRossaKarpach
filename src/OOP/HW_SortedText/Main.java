...
public class Main {
    ...
    public static void main(String[] args) {
        String story = "Since 1066 there have been forty monarchs in England, thirty-five kings, five queens and " +
                "seven dynasties. Only fourteen monarchs have stayed on the throne for more than twenty - five years, " +
                "one of them is Queen Elizabeth II Every royal house or ‘dynasty’ has a surname. In Britain’s case " +
                "that name is Windsor Queen Elizabeth II is the fourth Windsor monarch. She is also the head of a " +
